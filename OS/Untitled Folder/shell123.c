...
void main()
{
	...
	gets(str);
	strcpy(string,str);
		if(strstr(string, pipe_symbol)!=NULL)			PIPE_function();
		else if(strstr(string, output_symbol)!=NULL)		OR_function();
		else if(strstr(string, input_symbol)!=NULL)		IR_function();
		else{
